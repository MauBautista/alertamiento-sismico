// JS único de la landing: revelado de encabezados al hacer scroll,
// arranque y repetición del esquema, y nada más. Presupuesto: < 3 KB gz.
...
// --- Esquema «el edificio se protege solo» ---
...
function correrSimulacro(): void {
  ...
  if (avisoSimulacro) {
    avisoSimulacro.textContent =
      "Simulacro ejecutado: la señal de SASMEX recorre el gabinete y acciona los cuatro canales.";
  }
}
