// Agrupación de la traza BMS (T-1.50): la tabla incident_actions es un
// timeline append-only y un incidente SASMEX real dispara siren/strobe/gas/
// elevator/door VARIAS veces — pintarla plana se percibe como "duplicados".
// El design system pide UNA fila por actuador con su ÚLTIMO estado (+×N),
// expandible a la traza completa auditada. Funciones puras, sin DOM.
