...
<!-- conformidad:inicio -->
_Generado por `deploy/cloud/conformidad.sh` (`make cloud-conformidad`) el 2026-09-22T14:42:40Z · HEAD `3fb22a6` · consola https://16-58-11-196.sslip.io. Se regenera entero: no editar entre los marcadores._

| Pieza | Veredicto | Evidencia |
|---|---|---|
| build de la nube | 🟢 VERDE | /api/health.build=3fb22a6 == HEAD |
| esquema de la nube | 🟢 VERDE | estado=al_dia aplicada=0069_mapa_de_sacudida == última migración del repo (0069_mapa_de_sacudida) |
| servicios del compose en la instancia | 🟢 VERDE | 8/8 declarados corriendo (imagen :3fb22a6) |
...
| release activa del Pi | 🟢 VERDE | release 20260921T220025Z-10a8b3b: nada de lo que el gabinete ejecuta cambió desde 10a8b3b (HEAD 3fb22a6) |
| modo prueba del Pi | 🟢 VERDE | test_mode.active=false · audio.profile: {"applied":{},"rejected":{},"test_tone":true} |
| APK del Pixel | 🟢 VERDE | com.takab.ailert 0.1.0 instalado 2026-09-22 08:26:28 ≥ último cambio de mobile/ (2793be8 2026-09-21T15:30:51-06:00) |

**RESUMEN:** 19 VERDE · 0 AMARILLO · 0 ROJO · 0 NO MEDIDO
<!-- conformidad:fin -->
